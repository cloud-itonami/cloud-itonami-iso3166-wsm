...
(defn -main [& _]
  (let [db (store/seed-db)
        actor (op/build db)]
    (println "== engagement/intake eng-1 (WSM, clean) ==")
    ...
    (println "== jurisdiction/assess eng-4 (sets up procurement-authority-insufficient) ==")
    ...
    (println "== filing/submit eng-4 (procurement-authority-insufficient -> HARD hold) ==")
